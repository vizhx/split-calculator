...
const ResultsSection = ({ members, calculations }) => {
  const totalAmount = Object.values(calculations.memberTotals || {}).reduce((acc, curr) => acc + curr, 0);
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4 text-teal-700">
           ...
           <div className="mb-4 text-teal-700">
              <strong className="text-lg font-semibold ">Total Amount:</strong> ₹{totalAmount.toFixed(2)}
          </div>
